...
## Today {.center style="text-align: center;" background="white"}
...
# Hi! {.text-wash-black background="linear-gradient(45deg, cyan, lime)"}
...
## Poll: what tools do you use? {.text-lime-cyan style="text-align: center;"}
...
# Quarto:<br>[Literate programming for[everyone]{.hl .hl-purple}]{style="font-size:75%;"} { background="linear-gradient(45deg, #4a00e0, #ff0099)"}
...
## Notebooks or documents: your choice {.text-indigo-pink background="white" style="text-align:center"}
...
## R, Python, Julia: your choice {.text-indigo-pink background="white" style="text-align:center"}
...
## Your choice of editor {.text-indigo-pink background="white" style="text-align: center"}
...
## RStudio visual editor {.text-indigo-pink background="white" style="text-align: center"}
...
# Spicing up Quarto<br>[with [reactivity]{.hl .hl-red} and [Observable JS]{.hl .hl-red}]{style="font-size:75%;"} { background="linear-gradient(45deg, #ed213a, #93291e)"}
...
::: {.fragment}
... and then reference it in some text!
...
## Quarto helps you write documents... {.center background="white"}
...
## Quarto help you make documents that react to users {.center background="white"}

... and you might learn JavaScript by accident!

## A checklist for trying Quarto {.center background="white"}

🔴 Download Quarto from [quarto.org](https://quarto.org)
...
[**twitter: @jimjam-slam**](https://twitter.com/jimjam-slam)